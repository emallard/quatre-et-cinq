...
module qec {
    export class bspline
    {
        ...
        setPoints(points:number[][],degree,copy){
            if(copy){
                this.points = []
            ...
            if(degree == 2){
                this.baseFunc = (x)=>this.basisDeg2(x);
                this.baseFuncRangeInt = 2;
            }else if(degree == 3){
                this.baseFunc = (x)=>this.basisDeg3(x);
                this.baseFuncRangeInt = 2;
            }else if(degree == 4){
                this.baseFunc = (x)=>this.basisDeg4(x);
                this.baseFuncRangeInt = 3;
            }else if(degree == 5){
                this.baseFunc = (x)=>this.basisDeg5(x);
                this.baseFuncRangeInt = 3;
            }
        }

        seqAt(dim:number) : (x:number)=>number {
